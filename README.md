...
**why a certain design works**, **where the bottlenecks are**,  
and **how performance can be improved through iteration**.
...
- Prefer explaining trade-offs, failure cases, and improvements  
  rather than just presenting final results
- Actively document trial-and-error and design decisions on my blog
...
- Tuned performance with attack/defense weights and move ordering
- Focused on moving from a naive implementation to a **practically playable speed**

👉 Repository: https://github.com/ImSoohwan/gomoku-minimax-ai  
...
## 🛠 Tech Stack
- **Languages**: Python, C
- **Tools / Frameworks**: Pygame, Git, GitHub
- **Interests**:
  - Game AI (Minimax, heuristics)
...
👉 https://blog.naver.com/PostList.naver?blogId=d_soohwan&from=postList&categoryNo=7#
(only korean)
